...
public sealed class AdminAreaColoring : MonoBehaviour {
  ...
  private void Start() {
    ...
    mapsService.Events.RegionEvents.DidCreate.AddListener(args => {
      ...
      Extruder.AddAreaOutline(args.GameObject, borderMaterial, args.MapFeature.Shape, BorderWidth);
    });
    ...
    mapsService.MakeMapLoadRegion()
        .AddCircle(mapsService.Coords.FromLatLngToVector3(LoadingCenter), 1000000)  // 1,000 km.
